...
dag = DAG(
    dag_id='demo_dag_for_alerting_final',
...
insert_new_record_into_audit_table = PythonOperator(
    ...
    python_callable=helper.alert_notif_failure,
    op_kwargs={
        'dag_id': dag.dag_id,
        'task_id': 'insert_new_record_into_audit_table',
        'func': helper.insert_into_audit_table_for_adhoc_data,
        'kwargs': {}
    },
    dag=dag
)
...
refresh_external_table = PythonOperator(
    ...
    op_kwargs={
        'dag_id': dag.dag_id,
        'task_id': 'refresh_external_table',
        'func': helper.refresh_crm_campaign_run_external_table,
        'kwargs': {}
    },
    dag=dag
)
...
skip_run_task = PythonOperator(
    task_id="skip_run",
    python_callable=helper.alert_notif_skipped,
    op_kwargs={
        'dag_id': dag.dag_id,
        'task_id': 'skip_run',
    },
